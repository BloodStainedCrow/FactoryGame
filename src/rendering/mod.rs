...
fn texture_atlas() -> TextureAtlas {
    TextureAtlas {
        ...
        items: vec![
            ...
            sprite_from_path!("temp_assets/krastorio/advanced-circuit.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/krastorio/coke.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/krastorio/steel-beam.png", 1),
            sprite_from_path!("temp_assets/krastorio/steel-pipe.png", 1),
            sprite_from_path!("temp_assets/krastorio/production-tech-card.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            ...
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/krastorio/processing-unit.png", 1),
            sprite_from_path!("temp_assets/krastorio/utility-tech-card.png", 1),
            sprite_from_path!("temp_assets/krastorio/optimization-tech-card.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
            sprite_from_path!("temp_assets/plate.png", 1),
