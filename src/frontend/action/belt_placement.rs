...
mod test {
    use crate::{
        frontend::{
            action::action_state_machine::{ActionStateMachineState, HeldObject},
            world::{
                Position,
    ...
    //             let mut state = GameState::new("TEST_GAMESTATE".to_string(), GenerationInformation::default(), &DATA_STORE);
